    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 ease-in-out group">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
            <StarRating rating={club.rating.score} readOnly />
            <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">({club.rating.count} 评价)</span>
        </div>
        <div className="flex justify-between items-center mt-4">
          ...
          <Link to={`/clubs/${club.id}`} className="inline-flex items-center font-semibold text-indigo-600 dark:text-indigo-400 group-hover:text-indigo-800 dark:group-hover:text-indigo-300">
            查看详情
