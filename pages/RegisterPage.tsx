...
import { NuaaLogoIcon, LockClosedIcon, UsersIcon, EyeIcon, EyeOffIcon } from '../components/icons';
...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    const pwdError = validatePassword(userPassword);
    if (pwdError) {
      alert(pwdError);
      return;
    }
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <input
                id="userPassword" name="userPassword" type={showPassword ? 'text' : 'password'} autoComplete="new-password" required
              ...
              />
              <button type="button" onClick={() => setShowPassword(v => !v)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
            ...
            <div className="relative">
              ...
              <LockClosedIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400"/>
              <input
                id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} autoComplete="new-password" required
                className="appearance-none rounded-none relative block w-full px-3 pl-10 pr-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                placeholder="确认密码"
              />
